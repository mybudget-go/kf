...
func (g *globalKTable) Topology() topology.SubTopologyBuilder {
	panic("implement me")
}

func (g *globalKTable) Start() error {
	panic("implement me")
}

func NewGlobalTable(topic string, keyEncoder encoding.Builder, valEncoder encoding.Builder, store string, options ...GlobalTableOption) GlobalTable {
	return &globalKTable{
		storeName: store,
		store:     nil,
		//options:   options,
